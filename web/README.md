...
3. **Root Directory:** biarkan kosong (`.` / repo root) — jangan set ke `web`, supaya folder `reports/` ikut ter-build
4. Framework / build: pakai `vercel.json` di root (install & build di `web/`)
5. Deploy
